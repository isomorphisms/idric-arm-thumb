...
write_receipt() {
  ...
  diagnostic=${2:-none}
  {
    ...
    for stage in compiler_checkout compiler_build compiler_api_install backend_build wegert_direct_dex native_activity_shells dex_generation dex_validation art_execution; do
      case " $passed " in
